...
def save_to_db(title, text, media_url, media_type, category):
    try:
        ...
        if c.fetchone() is not None:
            ...
            return None  # Вернуть None, если новость дублируется
        ...
        return news_id  # Вернуть ID новости
...
def run_download_script(url, news_id):
    subprocess.check_call(["D:/pythonProject/bot_3/venv/Scripts/python.exe", "D:/pythonProject/bot_3/down_video.py", url, str(news_id)])
